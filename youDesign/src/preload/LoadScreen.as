package preload
{
	...
	{
        //~ Settings ----------------------------------------------------------
        private static var _BarWidth     : int = 350;  // Progress bar width
        private static var _BarHeight    : int = 12;   // Progress bar height
        private static var _LogoHeight   : int = 92;   // Logo picture height
        private static var _LogoWidth    : int = 360;  // Logo picture width
        ...
        private static var _BarOuterBorder : uint = 0xFFFFFF; // color of outer border
        //private static var _BarColor       : uint = 0xFFFFFF; // color of prog bar
        private static var _BarColor       : uint = 0x0479BF; // color of prog bar
        private static var _BarInnerColor  : uint = 0x0479BF; // inner color of prog bar
